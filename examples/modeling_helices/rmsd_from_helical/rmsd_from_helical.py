...
if not os.path.exists("F_RMSD_T.dat"):
    ...
    for epsilon in epsilon_list:
        print(
            "Calculating the free energy as a function of RMSD to the idyllic helical structure."
        )
        ...
        mbar, E_kn, result, dresult, new_temp_list = get_mbar_expectation(
            replica_energies, temperature_list, 0
        )
    ...
    data_file.write(
        "Temperature (Kelvin),RMSD to Native (Angstroms),Free Energy (Dimensionless)\n"
    )
